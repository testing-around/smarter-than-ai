...
1. Download `SmarterThanAI-1.0.1-preview.apk` (versionName **1.0.1**, versionCode **2**) to the device (Downloads is fine). Latest preview: https://github.com/testing-around/smarter-than-ai/releases/download/v1.0.1-preview/SmarterThanAI-1.0.1-preview.apk (SHA-256 `572f5e46557451d92aea0f9c4ada949600f94bfe7abe7ffb2d1517dad56a6977`).
