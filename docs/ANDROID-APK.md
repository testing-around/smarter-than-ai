...
1. Download `SmarterThanAI-1.0.2-preview.apk` (versionName **1.0.2**, versionCode **3**) from https://github.com/testing-around/smarter-than-ai/releases/download/v1.0.2-preview/SmarterThanAI-1.0.2-preview.apk
